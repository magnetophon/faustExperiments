...
, compGain
   with {
    ...
    lookaheadSamples = 64;
    rawGain =
      smootherARorder(orderHold, orderHold, orderHold, 0, timeHold, abs(x))
      :ba.linear2db
   ...
   timeAtt = mainGroup(hslider("att time[scale:log]", 0.001, 0.001, 0.10, 0.001)-0.001);
   ...
   thresh = mainGroup(hslider("[14]threshold[unit:dB]",-10,-30,0,0.1));
   knee =
